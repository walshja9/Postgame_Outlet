...
class WorkflowStatusTests(unittest.TestCase):
    ...
    def test_new_component_failures_do_not_change_main_health(self):
        for key, prefix in [('totals_shadow','totals'), ('weights_shadow','weights'),
                            ('replacement_depth','replacement_depth'), ('injury_usage','injury_usage'),
                            ('offensive_inventory','offensive_inventory'), ('offensive_usage','offensive_usage'),
                            ('score_range_collection','score_range_collection'), ('ats','ats')]:
